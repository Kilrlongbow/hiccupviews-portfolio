 ...
 *
 * Images arranged in a 3D sphere via Fibonacci distribution. Supports
 * drag-to-rotate with momentum, auto-rotation, dynamic scaling, collision
 * avoidance, and a modal viewer. Touch + mouse supported.
 */
...
export interface ImageData {
  id: string;
  src: string;
  /** Optional higher-resolution source shown in the modal (falls back to src). */
  full?: string;
  alt: string;
  title?: string;
  description?: string;
      ...
      >
        ...
        >
          <div className="relative aspect-square">
            <img
              src={selectedImage.full ?? selectedImage.src}
